    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="uploadForm" action="{{ route('import') }}" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-3">
                        <div class="input-group col-3 mb-3">
                            ...
                            <input type="text" id="codigo" class="form-control" aria-label="Código"
                    ...
                    <div class="col">
                        <div class="input-group col-3 mb-3">
                            ...
                            <input type="text" id="descricao" class="form-control" aria-label="Descrição"
                                   aria-describedby="basic-addon1">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <div class="input-group col mb-3">
                            ...
                            <input type="text" id="codigoBarras" class="form-control" aria-label="Código de barras"
                                   aria-describedby="basic-addon1">
                        </div>
                    </div>
                    <div class="col">
                        <div class="input-group col mb-3">
                            ...
                            <input type="text" id="codigoERP" class="form-control" aria-label="Código ERP"
                                   aria-describedby="basic-addon1">
                        </div>
                    </div>
                    <div class="col">
                        <div class="input-group mb-3">
                            ...
                            <select class="form-control" id="inputGroupSelectFornecedor">
                ...
                <div class="row">
                    <div class="col">
                        <div class="input-group col mb-3">
                            ...
                            <input type="text" id="situacao" class="form-control" aria-label="Situação"
                                   aria-describedby="basic-addon1">
                        </div>
                    </div>
                    <div class="col">
                        <div class="input-group mb-3">
                            ...
                            <select class="form-control" id="inputGroupSelectTributacao">
                                <option selected>Koloss</option>
                                <option value="hghgfh">hghgfh</option>
                                <option value="2">Two</option>
                                <option value="3">Three</option>
                            </select>
                        </div>
                ...
                <button type="button" class="btn btn-primary mt-3" id="clearButton">Salvar</button>
